...
ntpuLogoMatrix[1:183,300] <- "red"
ntpuLogoRaster_redFrame <- plot(as.raster(ntpuLogoMatrix))
ntpuLogoRaster_redFrame
...
ntpuLogoRaster_greySelect <- plot(as.raster(ntpuLogoMatrix))
ntpuLogoRaster_greySelect
...
{ library(stringr)
  a <- as.matrix(ntpuLogoRaster_blue)
  b <- str_detect(a, pattern="transparent")
  whichIsNotTransparent <- str_which(b, pattern="FALSE")
}
